      ...
      <div className="bg-base dark:bg-black text-gray-900 dark:text-gray-100 min-h-screen flex flex-col font-sans">
        ...
        <main className="flex-1 flex flex-col items-center px-6 py-12">
          <h1 className="text-2xl font-bold mb-8">
            <span className="text-black dark:text-white">About</span> <span className="text-prim">Us</span>
          </h1>
          
          {/* About personAI */}
          <p className="text-lg text-gray-700 dark:text-white text-center max-w-3xl">
          ...
          <div className="mt-12 max-w-4xl text-center space-y-8">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4">
                <span className="text-black dark:text-white">Our</span> <span className="text-prim">Mission</span>
              </h2>
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4">
                <span className="text-black dark:text-white">Our</span> <span className="text-prim">Vision</span>
              </h2>
              <p className="text-lg text-gray-700 dark:text-white">
          ...
          <h2 className="text-2xl font-bold mt-16 mb-6">
            <span className="text-black dark:text-white">Meet The</span> <span className="text-prim">Developers</span>
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {developers.map((dev) => (
              <div key={dev.name} className="border-2 border-prim p-6 rounded-lg shadow-lg text-center w-60 bg-white dark:bg-gray-900">
              <div className="w-24 h-24 bg-gray-200 dark:bg-gray-700 rounded-full mx-auto flex items-center justify-center text-2xl font-bold text-prim">
                {dev.name.charAt(0)}
              </div>
              <p className="mt-4 text-lg font-bold text-black dark:text-white">{dev.name}</p>
              <p className="text-gray-700 dark:text-white text-lg">BMS College of Engineering</p>
